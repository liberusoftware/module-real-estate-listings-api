...
> This optional API presentation package exposes approved HTTP operations for the Listings domain module. It presents exactly one independent module, delegates all authoritative behavior to that module's public actions/queries/policies, and contains no other module's API logic.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-real-estate-listings-api?sort=semver)](https://github.com/liberusoftware/module-real-estate-listings-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-real-estate-listings-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-real-estate-listings-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-real-estate-listings-api
```
...
<a href="https://github.com/liberusoftware/module-real-estate-listings-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-real-estate-listings-api" alt="Contributors to liberusoftware/module-real-estate-listings-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-real-estate-listings-api/graphs/contributors).
